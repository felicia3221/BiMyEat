...
export function GetStarted() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      // Contoh pesan dari Supabase: "Invalid login credentials",
    ...
    if (!isSignIn) {
      // TODO: kalau "Confirm email" masih ON di Supabase dashboard,
      // user belum bisa langsung login sampai klik link di emailnya.
      // Ganti toast + navigate di bawah jadi arahan "cek email kamu"
      // begitu fitur itu dinyalain lagi untuk production.
      ...
      <div className="min-h-screen flex">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
          ...
          <CardContent className="space-y-6">
            ...
            {/* Social Login Buttons — belum diimplementasi, disabled biar jujur ke user */}
            <div className="space-y-3">
              <Button variant="outline" className="w-full h-12 gap-3 rounded-2xl border-gray-200 opacity-60 cursor-not-allowed" type="button" disabled>
                ...
                Lanjut dengan Google (Segera Hadir)
              </Button>
              ...
              <Button variant="outline" className="w-full h-12 gap-3 rounded-2xl border-gray-200 opacity-60 cursor-not-allowed" type="button" disabled>
                ...
                Lanjut dengan Apple (Segera Hadir)
              </Button>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              >
                {isSubmitting ? 'Loading...' : isSignIn ? 'Masuk' : 'Buat Akun'}
              </Button>
            </form>
